                                                ...
                                                <table class="table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <th scope="col"><button type="button" onclick="Finalizar('1')" id="final-btn" class="btn btn-outline-success">(F2) Finalizar</button></th>
                                                        </tr>
                                                    </tfoot>
                                                </table>
                                            </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button class="close" type="button" data-dismiss="modal" aria-label="Close" tabindex="-1">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                <form onsubmit="Finalizar('2');return false;">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" onkeydown="moeda(this);CalcRetorno();" onkeyup="moeda(this);CalcRetorno();" id="dinheiro-final" placeholder="R$ 10,00" tabindex="0">
                    </div>
                    <div class="form-group">
                        <label for="credito-final"> <i class="far fa-credit-card"></i> Crédito</label>
                        <input type="text" class="form-control" onkeydown="moeda(this);CalcRetorno();" onkeyup="moeda(this);CalcRetorno();" id="credito-final" placeholder="R$ 10,00" tabindex="1">
                    </div>
                    <div class="form-group">
                        <label for="debito-final"> <i class="fas fa-credit-card"></i> Debito</label>
                        <input type="text" class="form-control" onkeydown="moeda(this);CalcRetorno();" onkeyup="moeda(this);CalcRetorno();" id="debito-final" placeholder="R$ 10,00" tabindex="2">
                    </div>
                    <div class="form-group">
                        <label for="debito-final"> <i class="fas fa-coins"></i> Pix</label>
                        <input type="text" class="form-control" onkeydown="moeda(this);CalcRetorno();" onkeyup="moeda(this);CalcRetorno();" id="pix-final" placeholder="R$ 10,00" tabindex="3">
                    </div>
                    <hr>
                    <div class="form-group">
                        <label for="desconto-final"> <i class="fas fa-user-tag"></i> Desconto</label>
                        <input type="text" class="form-control" onkeydown="moeda(this);CalcRetorno();" onkeyup="moeda(this);CalcRetorno();" onchange="moeda(this);CalcRetorno();" id="desconto-final" placeholder="R$ 10,00" tabindex="4">
                    </div>
                    <hr>
                    <div class="form-group">
            ...
            <div class="modal-footer">
                <button class="btn btn-outline-danger" type="button" data-dismiss="modal" tabindex="-1">Cancelar</button>
            </div>
        </div>
    </div>
</div>
